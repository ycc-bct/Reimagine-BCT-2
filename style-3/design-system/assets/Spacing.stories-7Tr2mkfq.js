import{h as c,l as n}from"./helpers-CtHPbzQ_.js";const b={title:"Foundations/Spacing"},t=(i,v)=>`
  <div style="display:flex;align-items:center;gap:18px;padding:9px 0">
    ...
    <div style="font:400 13.5px var(--font-body);color:var(--text-mid)">${v}</div>
  </div>`,e=()=>c(`
  <div style="padding:8px">
    ...
    ${n("Stacking interval")}
    ${t("10px","A title and the line directly under it")}
    ${t("14px","Eyebrow → section title")}
    ${t("20px","Section title → lede paragraph")}
    ${t("28px","A block and its CTA")}
    ${t("32px","Columns in a .section-head")}
    ${t("56px",".section-head → the content it introduces")}
    ${n("Section padding")}
    ${t("90px","Standard section padding-block")}
    ${t("80px","Compact section, and every section below 720px")}
    ${t("52px","A section that should hug the band above it")}
    ${t("72px","Fixed nav height, and the scroll-padding-top that matches it")}
  </div>
`),a=()=>c(`
  <div style="padding:8px">
...
`);var o,d,r;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`() => h(\`
  <div style="padding:8px">
    <div style="font:400 13.5px var(--font-body);color:var(--text-mid);max-width:64ch">
      Inside a block, spacing steps through this set. Do not invent intermediate values.
    </div>
...
\`)`,...(r=(d=e.parameters)==null?void 0:d.docs)==null?void 0:r.source}}};var s,p,l;a.parameters={...a.parameters,docs:{...(s=a.parameters)==null?void 0:s.docs,source:{originalSource:`() => h(\`
  <div style="padding:8px">
    <div style="font:400 13.5px var(--font-body);color:var(--text-mid);max-width:64ch;margin-bottom:20px">
      One token controls every page gutter: <code style="color:var(--blue-300)">--pad-x: clamp(24px, 5vw, 72px)</code>.
      Nothing else sets a page gutter. Resize to watch it move.
...
\`)`,...(l=(p=a.parameters)==null?void 0:p.docs)==null?void 0:l.source}}};const g=["StackingInterval","PageGutter"];export{a as PageGutter,e as StackingInterval,g as __namedExportsOrder,b as default};
