import{h as p}from"./helpers-CtHPbzQ_.js";const z={title:"Foundations/Typography"},t=(e,a,n,o)=>`
  <div style="border-bottom:1px solid var(--border);padding:26px 0">
    <div style="display:flex;justify-content:space-between;gap:24px;align-items:baseline;margin-bottom:14px">
      <div style="font:600 13.5px var(--font-body);color:var(--text-hi)">${e}</div>
      <div style="font:400 12px var(--font-body);color:var(--text-low);text-align:right">${a}</div>
    </div>
    <div style="${n}">${o}</div>
  </div>`,i=()=>p(`
...
`),s=()=>{const e=p(`
  ...
  `),a=()=>{const n=e.querySelector(".probe"),o=e.querySelector(".readout");if(!n||!o)return;const b=n.getBoundingClientRect().height/parseFloat(getComputedStyle(n).lineHeight),l=Math.round(b*100)/100,d=e.getBoundingClientRect().width;if(d<768){o.innerHTML=`<span style="color:var(--text-low)">
        ${l} lines at ${Math.round(d)}px — rule does not bind below 768px</span>`;return}const h=l<=2.05;o.innerHTML=`<span style="color:${h?"#5FBEEA":"#FF6B6B"}">
      ${l} lines at ${Math.round(d)}px — ${h?"passes":"FAILS: rewrite the copy, do not shrink the font"}</span>`};return requestAnimationFrame(a),new ResizeObserver(a).observe(e),e};var c,v,f;i.parameters={...i.parameters,docs:{...(c=i.parameters)==null?void 0:c.docs,source:{originalSource:`() => h(\`
  <div style="padding:8px">
...
\`)`,...(f=(v=i.parameters)==null?void 0:v.docs)==null?void 0:f.source}}};var m,g,u;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:`() => h(\`
  <div style="padding:8px">
    <div style="font:400 13.5px var(--font-body);color:var(--text-mid);max-width:64ch;margin-bottom:8px">
      Three roles, one value each. Every paragraph on the page resolves to one of these — a section
      never invents its own size. If a paragraph seems to need a fourth, the layout is wrong.
...
\`)`,...(u=(g=r.parameters)==null?void 0:g.docs)==null?void 0:u.source}}};var y,x,w;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`() => {
  const el = h(\`
    <div style="padding:8px">
      <div style="font:400 13.5px var(--font-body);color:var(--text-mid);max-width:64ch;margin-bottom:24px">
        Titles must never exceed two lines. Resize the preview and watch the counter — it measures
  ...
  return el;
}`,...(w=(x=s.parameters)==null?void 0:x.docs)==null?void 0:w.source}}};const B=["Scale","BodyRoles","LineBreakRule"];export{r as BodyRoles,s as LineBreakRule,i as Scale,B as __namedExportsOrder,z as default};
