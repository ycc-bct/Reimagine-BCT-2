import{h as d}from"./helpers-CtHPbzQ_.js";const z={title:"Foundations/Responsive"},a=()=>{const t=d(`
  ...
  `),r=()=>{const e=t.querySelector(".readout"),o=k=>getComputedStyle(t.querySelector(k)).fontSize,s=Math.round(t.getBoundingClientRect().width),$=s<768?"mobile tier (<768)":"desktop tier (≥768)";e.textContent=`${s}px — ${$} · lede ${o(".r-lede")} · body ${o(".r-body")} · small ${o(".r-small")}`};return requestAnimationFrame(r),new ResizeObserver(r).observe(t),t},i=()=>d(`
  <div style="padding:8px">
...
`),l=()=>{const t=[["Navigation","drawer","drawer","drawer","inline","inline"],["Capability cards","1","2","2","3","3"],["Product cards","1","2","2","3","4"],["Stats","1","3","3","3","3"],["Footer","1","2","2","3","3"],["Why BCT","swipe rail","swipe rail","swipe rail","grid","grid"]],r=(e,o)=>`<td style="padding:12px 14px;border-bottom:1px solid var(--border);font:${o?"600":"400"} 13px var(--font-body);color:${o?"var(--text-hi)":e==="drawer"||e==="swipe rail"?"var(--blue-300)":"var(--text-mid)"}">${e}</td>`;return d(`
    <div style="padding:8px">
      ...
      <div style="overflow-x:auto">
        <table style="border-collapse:collapse;min-width:560px;width:100%">
          <thead><tr>
            ${["","<640","640","768","1024","1280+"].map(e=>`<th style="text-align:left;padding:12px 14px;border-bottom:1px solid var(--border);font:600 11px var(--font-body);letter-spacing:.14em;text-transform:uppercase;color:var(--text-low)">${e}</th>`).join("")}
          </tr></thead>
          <tbody>${t.map(e=>`<tr>${r(e[0],!0)}${e.slice(1).map(o=>r(o)).join("")}</tr>`).join("")}</tbody>
        </table>
      </div>
    </div>
  `)};var p,c,v;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`() => {
  const el = h(\`
    <div style="padding:8px">
      <div style="font:400 13.5px var(--font-body);color:var(--text-mid);max-width:64ch">
        The three body roles keep their names at every width — only their values change. Switch the
  ...
  return el;
}`,...(v=(c=a.parameters)==null?void 0:c.docs)==null?void 0:v.source}}};var h,x,m;i.parameters={...i.parameters,docs:{...(h=i.parameters)==null?void 0:h.docs,source:{originalSource:`() => h(\`
  <div style="padding:8px">
    <div style="font:400 13.5px var(--font-body);color:var(--text-mid);max-width:64ch;margin-bottom:24px">
      Every interactive element is at least 44px tall on touch widths. The arrow link is the usual
      offender — its text is only ~20px tall, so it needs an explicit minimum.
...
\`)`,...(f=(y=n.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};var u,b,w;l.parameters={...l.parameters,docs:{...(u=l.parameters)==null?void 0:u.docs,source:{originalSource:`() => {
  ...
  \`);
}`,...(w=(b=l.parameters)==null?void 0:b.docs)==null?void 0:w.source}}};const C=["BodyScaleFloor","TouchTargets","SwipeRail","BreakpointMap"];export{a as BodyScaleFloor,l as BreakpointMap,n as SwipeRail,i as TouchTargets,C as __namedExportsOrder,z as default};
